...
with open("nodePath_testcase1.txt", "w+") as sol_file:
#with open("nodePath_testcase2.txt", "w+") as sol_file:
#with open("nodePath_testcase3.txt", "w+") as sol_file:
#with open("nodePath_testcase4.txt", "w+") as sol_file:
#with open("nodePath_testcase5.txt", "w+") as sol_file:
    for node in path:
